...
(function ($) {
    $.fn.hoverclock = function (options) {
        ...
        h_hoverClock.css({ "width": settings.h_width, "height": settings.h_height, "position": "fixed", "background-color": settings.h_backColor, "border-radius": settings.h_radius,"border":"solid 1px", "border-color": settings.h_borderColor })
